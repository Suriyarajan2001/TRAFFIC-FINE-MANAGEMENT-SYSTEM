...
<head>
    ...
    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Traffic Fine Management System ">
    <meta name="keywords" content="Traffic, Fine, System">
    <meta name="author" content="Suriya Rajan">
    ...
    <div class="topnavbar animated fadeIn">
        ...
        <ul class="topnavbar-nav">
            <li class="topnav-item">
                         ...
                         <a href="index.php"><h1 style="color:white;font-family:ALBERTUS"><img src="assets/img/logo.png" class="logo logo-light"></img>TFMS</h1></a>
            </li>
        </ul>
        <!-- end topnav left -->
        <!-- topnav right -->
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+91714590249"><i class="fas fa-phone"></i> +91 714590249</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Inquiry via email</h4>
                        <ul>
                            <li><a style="text-transform: lowercase;" href="mailto: tfms@gmail.com" target="_blank"> <i class="fas fa-envelope"></i> tfms@gmail.com</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
                        <h4>Other Links</h4>
                    ...
                    <div class="footer-col">
                        ...
                        <a href="index.php"><h1 style="color:white;font-family:ALBERTUS"><img src="assets/img/logo.png" class="logo logo-light"></img><h5 style="color:white;font-family:ALBERTUS">TRAFFIC FINE MANAGEMENT SYSTEM🚧</h5></h1></a>
                    </div>
                </div>
            </div>
        </footer>
